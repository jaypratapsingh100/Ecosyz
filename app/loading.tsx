/**
 * Root loading UI – shown immediately while the app/layout loads.
 * Prevents blank screen or browser fallback (e.g. Google search) when dev server is cold-starting.
 */
