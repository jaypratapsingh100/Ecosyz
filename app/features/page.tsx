...
export default function FeaturesPage() {
  const features = [
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-purple-400/10 hover:border-purple-400',
                  ...
                  <div className="grid md:grid-cols-3 gap-8 mb-12">
                    {features.map((feature, idx) => (
                      ...
                      >
                        ...
                        <div className={`w-full px-6 py-3 rounded-lg bg-transparent border-2 ${feature.borderColor} ${feature.buttonTextColor} font-semibold transition-all duration-300 group-hover:bg-gradient-to-r ${feature.color} group-hover:text-gray-900 group-hover:border-transparent`}>
