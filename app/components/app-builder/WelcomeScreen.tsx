    ...
    <div className="flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto px-4">
        ...
        <p className="text-gray-400 text-sm mb-6">
          Get started by creating a sample project or start a new project from scratch.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            onClick={onCreateSample}
            disabled={isCreatingSample || isCreatingNew || !isAuthenticated}
          ...
          {onCreateReactSample && (
            <button
              ...
              disabled={isCreatingSample || isCreatingReactSample || isCreatingNew || !isAuthenticated}
