        ...
        <div className="relative z-10 w-full">
          <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
            ...
            <div className="text-center mb-6 sm:mb-8 px-2">
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 tracking-tight flex flex-wrap items-center justify-center gap-2 sm:gap-3" style={{
                ...
                <span className="text-emerald-400 text-xl sm:text-3xl md:text-4xl lg:text-5xl animate-pulse font-light flex items-center justify-center" style={{ fontFamily: 'var(--font-space-grotesk)', lineHeight: '1', verticalAlign: 'middle' }}>*</span>
                ...
                <span className="text-cyan-400 text-xl sm:text-3xl md:text-4xl lg:text-5xl animate-pulse font-light flex items-center justify-center" style={{ fontFamily: 'var(--font-space-grotesk)', lineHeight: '1', verticalAlign: 'middle' }}>*</span>
            ...
            <div className="mb-8">
              <form onSubmit={handleBuild} className="relative">
                <div className="relative backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden focus-within:border-gray-600 transition-all duration-300 shadow-2xl" style={{ backgroundColor: '#141618' }}>
                  ...
                  <div className="px-3 sm:px-4 py-4 sm:py-6 min-h-[80px] sm:min-h-[100px] flex items-center">
                    <textarea
                      value={buildQuery}
                      onChange={(e) => setBuildQuery(e.target.value)}
                      placeholder="Explore open innovation, research, and solutions"
                      className="w-full bg-transparent text-white text-base sm:text-lg md:text-xl placeholder-gray-400 focus:outline-none resize-none overflow-hidden rounded-lg"
                  ...
                  {/* Control Bar - Bottom */}
                  <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 flex-wrap" style={{ backgroundColor: '#141618' }}>
                    {/* Plus Icon Button */}
                    <button
                      type="button"
                    ...
                    {/* Settings/Toggle Icon - Hide on mobile */}
                    <button
                      type="button"
                      className="hidden md:flex w-8 h-8 sm:w-10 sm:h-10 items-center justify-center bg-gray-700/50 hover:bg-gray-600 rounded-full transition-colors"
                      aria-label="Settings"
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      type="submit"
                      className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-gray-700/50 hover:bg-gray-600 rounded-full transition-colors flex-shrink-0 ml-auto sm:ml-0"
                      aria-label="Submit"
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
